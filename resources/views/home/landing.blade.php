                ...
                <form method="POST" action="{{ route('inquiries.store') }}">
                    ...
                    <div class="form-group" style="margin-bottom: 24px;">
                        ...
                        <input type="text" name="customer_name" id="customerName"
                            class="form-control-lp @error('customer_name') error @enderror" required
                            placeholder="Juan Dela Cruz" value="{{ old('customer_name') }}">
                    ...
                    <div class="form-group" style="margin-bottom: 24px;">
                        ...
                        <input type="email" name="customer_email" id="customerEmail"
                            class="form-control-lp @error('customer_email') error @enderror" required
                            placeholder="juan@gmail.com" value="{{ old('customer_email') }}">
